...
static SHIP_DATES: &[i32] = &[
    19920115, 19920301, 19920728, 19920915, 19921201, 19930210, 19930703, 19931115, 19931201,
    19930501, 19940202, 19940315, 19940630, 19940901, 19941130, 19950101, 19950316, 19950630,
    19950901, 19951201, 19960101, 19960315, 19960630, 19960901, 19961201, 19970101, 19970601,
    19971201, 19980101, 19980830,
];

static COMMIT_DATES: &[i32] = &[
    19920110, 19920225, 19920720, 19920910, 19921120, 19930205, 19930628, 19931110, 19931125,
    19930425, 19940130, 19940310, 19940625, 19940825, 19941120, 19941228, 19950310, 19950620,
    19950825, 19951120, 19951228, 19960310, 19960620, 19960825, 19961120, 19961228, 19970520,
    19971120, 19971228, 19980820,
];

static RECEIPT_DATES: &[i32] = &[
    19920125, 19920315, 19920810, 19920930, 19921215, 19930225, 19930720, 19931130, 19931215,
    19930515, 19940215, 19940330, 19940715, 19940920, 19941215, 19950120, 19950330, 19950715,
    19950920, 19951215, 19960120, 19960330, 19960715, 19960920, 19961215, 19970120, 19970620,
    19971215, 19980320, 19980915,
];
...
fn build_lineitem(rows: usize) -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            ...
            ColumnVector::Int32(l_linenumber),
        ),
        ("l_quantity".to_string(), ColumnVector::Float64(l_quantity)),
        (
            "l_extendedprice".to_string(),
            ColumnVector::Float64(l_extendedprice),
        ),
        ("l_discount".to_string(), ColumnVector::Float64(l_discount)),
        ("l_tax".to_string(), ColumnVector::Float64(l_tax)),
        (
            "l_returnflag".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(l_returnflag)),
        ),
        (
            "l_linestatus".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(l_linestatus)),
        ),
        ("l_shipdate".to_string(), ColumnVector::Date32(l_shipdate)),
        (
            "l_commitdate".to_string(),
            ColumnVector::Date32(l_commitdate),
        ),
        (
            "l_receiptdate".to_string(),
            ColumnVector::Date32(l_receiptdate),
        ),
        (
            "l_shipmode".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(l_shipmode)),
        ),
        (
            "l_shipinstruct".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(l_shipinstruct)),
        ),
    ])
...
static ORDER_DATES: &[i32] = &[
    19930115, 19930705, 19930215, 19940101, 19940901, 19940305, 19950101, 19950316, 19951101,
    19960201, 19920501, 19921201, 19930801, 19940601, 19941201, 19950101, 19960101, 19960701,
    19970101, 19971201,
];
static ORDER_STATUS: &[&str] = &[
    "F", "F", "F", "F", "F", "F", "O", "O", "O", "O", "F", "F", "F", "F", "F", "O", "O", "O", "O",
    "O",
];
...
fn build_orders() -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            ...
            ColumnVector::Utf8(Utf8Column::from_options(o_orderstatus)),
        ),
        (
            "o_totalprice".to_string(),
            ColumnVector::Float64(o_totalprice),
        ),
        ("o_orderdate".to_string(), ColumnVector::Date32(o_orderdate)),
        (
            "o_orderpriority".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(o_orderpriority)),
        ),
        (
            "o_shippriority".to_string(),
            ColumnVector::Int32(o_shippriority),
        ),
        (
            "o_comment".to_string(),
            ColumnVector::Utf8(Utf8Column::from_owned_options(o_comment)),
        ),
    ])
...
fn build_customer() -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            "c_name".to_string(),
            ColumnVector::Utf8(Utf8Column::from_owned_options(c_name)),
        ),
        ("c_nationkey".to_string(), ColumnVector::Int64(c_nationkey)),
        (
            "c_mktsegment".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(c_mktsegment)),
        ),
        ("c_acctbal".to_string(), ColumnVector::Float64(c_acctbal)),
        (
            "c_phone".to_string(),
            ColumnVector::Utf8(Utf8Column::from_owned_options(c_phone)),
        ),
        (
            "c_address".to_string(),
            ColumnVector::Utf8(Utf8Column::from_owned_options(c_address)),
        ),
        (
            "c_comment".to_string(),
            ColumnVector::Utf8(Utf8Column::from_owned_options(c_comment)),
        ),
    ])
...
fn build_nation() -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            "n_name".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(n_name)),
        ),
...
fn build_region() -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            "r_name".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(r_name)),
        ),
    ])
...
static PARTS: &[PartRow] = &[
    (
        1,
        "goldenrod lavender spring peru",
        "MFGR#1",
        "Brand#13",
    ...
    (
        8,
        "yellow cornflower sienna wheat",
        "MFGR#5",
        "Brand#11",
    ...
    (
        10,
        "slate pink black wheat chiffon",
        "MFGR#6",
        "Brand#55",
...
fn build_part() -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            "p_name".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(p_name)),
        ),
        (
            "p_mfgr".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(p_mfgr)),
        ),
        (
            "p_brand".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(p_brand)),
        ),
        (
            "p_type".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(p_type)),
        ),
        ("p_size".to_string(), ColumnVector::Int32(p_size)),
        (
            "p_container".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(p_container)),
        ),
        (
            "p_retailprice".to_string(),
            ColumnVector::Float64(p_retailprice),
        ),
    ])
...
fn build_supplier() -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            "s_name".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(s_name)),
        ),
        ("s_nationkey".to_string(), ColumnVector::Int64(s_nationkey)),
        ("s_acctbal".to_string(), ColumnVector::Float64(s_acctbal)),
        (
            "s_address".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(s_address)),
        ),
        (
            "s_phone".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(s_phone)),
        ),
        (
            "s_comment".to_string(),
            ColumnVector::Utf8(Utf8Column::from_options(s_comment)),
        ),
    ])
...
fn build_partsupp() -> RecordBatch {
    ...
    RecordBatch::new(vec![
        ...
        (
            ...
            ColumnVector::Float64(ps_supplycost),
        ),
    ])
